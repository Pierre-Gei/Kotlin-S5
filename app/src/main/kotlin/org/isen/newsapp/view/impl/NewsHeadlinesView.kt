...
public class NewsHeadlinesView(val controller:NewsController, title: String="News App"): INewsView, ActionListener {
    companion object logging

    private var newsList: JComboBox<Article> = JComboBox<Article>().apply {
        addActionListener(this@NewsHeadlinesView)
    }
    ...
    private fun createNewsComboBox(): JPanel {
        val contentPane = JPanel()
        contentPane.layout = BorderLayout()
        contentPane.add(JLabel("News Headlines"), BorderLayout.NORTH)
